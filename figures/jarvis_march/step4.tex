...
\begin{tikzpicture}
    ...
    \draw[black] (p2) -- (p1);
    \draw[black] (p1) -- (p3);
    \draw[gray,dashed] (p3) -- (p4);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p0)$);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p1)$);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p2)$);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p3)$);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p5)$);
    \draw[->,gray,dashed] (p4) -- ($(p4)!0.8!(p6)$);
