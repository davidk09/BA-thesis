...
% Adding a tikzpicture to draw the vertical line in the middle
\begin{tikzpicture}[remember picture,overlay]
  % Vertical line in the middle
  \draw[dashed] (current page.center);
  
  % Horizontal lines for separation
  \draw[dashed] (0, -3cm) -- (\textwidth, -3cm); % Adjust as necessary for spacing
  \draw[dashed] (0, -6cm) -- (\textwidth, -6cm); % Adjust as necessary for spacing
\end{tikzpicture}
...
\begin{minipage}[t]{0.33\textwidth}
  \centering
  \includestandalone{figures/jarvis_march/step2}  % Insert standalone picture in the right half
  \captionof{figure}{}      
\end{minipage}
...
\begin{minipage}[t]{0.33\textwidth}
\centering
\includestandalone{figures/jarvis_march/step4}  % Insert standalone picture in the right half
\captionof{figure}{}      
\end{minipage}
