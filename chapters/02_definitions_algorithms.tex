...
\begin{tikzpicture}
  ...
  \filldraw[red] (-1,-2) coordinate(p2) circle (2pt);
  \filldraw[red] (2,1) coordinate(p3) circle (2pt);
  \filldraw[red] (-2,0.5) coordinate(p4) circle (2pt);
  \filldraw[red] (-1,-1) coordinate(p5) circle (2pt);
